        ...
        <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
            <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                    ...
                    <p className='py-2 text-greay-600'>   I specialize in building mobile responsive front-end UI applications
                    ...
                    <p className='py-2 text-greay-600'> I started web developement in 2013 managing multiple e-commerce
